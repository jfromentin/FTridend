...
#ifndef PACKED_WORD_HPP
#define PACKED_WORD_HPP

#include "array.hpp"

class PackedWord:public Array<int>{
private:
  void normalize();
public:
  PackedWord(const Array<int>&);
};

inline
PackedWord::PackedWord(const Array<int>& tab):Array<int>(tab) {
  normalize();
}
